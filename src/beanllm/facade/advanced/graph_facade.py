...
from beanllm.domain.graph import BaseNode, GraphState, NodeCache
...
class Graph:
    ...
    def add_function_node(self, name: str, func: Callable, cache: bool = False, **kwargs):
        """함수 노드 추가"""
        from beanllm.domain.graph import FunctionNode
    ...
    def add_agent_node(
        ...
        **kwargs,
        ...
        """Agent 노드 추가"""
        from beanllm.domain.graph import AgentNode
    ...
    def add_llm_node(
        ...
        **kwargs,
        ...
        """LLM 노드 추가"""
        from beanllm.domain.graph import LLMNode
    ...
    def add_grader_node(
        ...
        **kwargs,
        ...
        """Grader 노드 추가"""
        from beanllm.domain.graph import GraderNode
