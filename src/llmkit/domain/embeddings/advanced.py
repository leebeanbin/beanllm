...
def find_hard_negatives(
    ...
    Example:
        ```python
        from llmkit.domain.embeddings import embed_sync, find_hard_negatives
...
def mmr_search(
    ...
    Example:
        ```python
        from llmkit.domain.embeddings import embed_sync, mmr_search
...
def query_expansion(
    ...
    Example:
        ```python
        from llmkit.domain.embeddings import Embedding, query_expansion
