...
class OpenAIEmbedding(BaseEmbedding):
    ...
    Example:
        ```python
        from llmkit.domain.embeddings import OpenAIEmbedding
...
class GeminiEmbedding(BaseEmbedding):
    ...
    Example:
        ```python
        from llmkit.domain.embeddings import GeminiEmbedding
...
class OllamaEmbedding(BaseEmbedding):
    ...
    Example:
        ```python
        from llmkit.domain.embeddings import OllamaEmbedding
...
class VoyageEmbedding(BaseEmbedding):
    ...
    Example:
        ```python
        from llmkit.domain.embeddings import VoyageEmbedding
...
class JinaEmbedding(BaseEmbedding):
    ...
    Example:
        ```python
        from llmkit.domain.embeddings import JinaEmbedding
...
class MistralEmbedding(BaseEmbedding):
    ...
    Example:
        ```python
        from llmkit.domain.embeddings import MistralEmbedding
...
class CohereEmbedding(BaseEmbedding):
    ...
    Example:
        ```python
        from llmkit.domain.embeddings import CohereEmbedding
