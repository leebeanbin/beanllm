...
class TextLoader(BaseDocumentLoader):
    ...
    Example:
        ```python
        from llmkit.domain.loaders import TextLoader
...
class PDFLoader(BaseDocumentLoader):
    ...
    Example:
        ```python
        from llmkit.domain.loaders import PDFLoader
...
class CSVLoader(BaseDocumentLoader):
    ...
    Example:
        ```python
        from llmkit.domain.loaders import CSVLoader
...
class DirectoryLoader(BaseDocumentLoader):
    ...
    Example:
        ```python
        from llmkit.domain.loaders import DirectoryLoader
