...
class PydanticOutputParser(BaseOutputParser):
    ...
    Example:
        ```python
        from llmkit.domain.parsers import PydanticOutputParser
...
class JSONOutputParser(BaseOutputParser):
    ...
    Example:
        ```python
        from llmkit.domain.parsers import JSONOutputParser
...
class CommaSeparatedListOutputParser(BaseOutputParser):
    ...
    Example:
        ```python
        from llmkit.domain.parsers import CommaSeparatedListOutputParser
...
class NumberedListOutputParser(BaseOutputParser):
    ...
    Example:
        ```python
        from llmkit.domain.parsers import NumberedListOutputParser
...
class DatetimeOutputParser(BaseOutputParser):
    ...
    Example:
        ```python
        from llmkit.domain.parsers import DatetimeOutputParser
...
class EnumOutputParser(BaseOutputParser):
    ...
    Example:
        ```python
        from enum import Enum
        from llmkit.domain.parsers import EnumOutputParser
...
class BooleanOutputParser(BaseOutputParser):
    ...
    Example:
        ```python
        from llmkit.domain.parsers import BooleanOutputParser
...
class RetryOutputParser(BaseOutputParser):
    ...
    Example:
        ...
        from llmkit.domain.parsers import RetryOutputParser, JSONOutputParser
