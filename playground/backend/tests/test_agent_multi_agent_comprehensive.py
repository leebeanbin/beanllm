...
def test_agent_complex_task():
    ...
    if response.status_code == 200:
        ...
        if "70" in result:
            print(f"✅ Correct answer found: 70")
        else:
            print(f"⚠️  Answer may not be explicitly shown")
