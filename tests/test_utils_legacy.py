...
class TestErrorHandling:
    ...
    def test_error_handler_import(self):
        ...
        from beanllm.utils.integration.error_handling import ErrorHandler

        assert ErrorHandler is not None

    def test_circuit_breaker_import(self):
        """CircuitBreaker import 테스트"""
        from beanllm.utils.integration.error_handling import CircuitBreaker

        assert CircuitBreaker is not None

    def test_rate_limiter_import(self):
        """RateLimiter import 테스트"""
        from beanllm.utils.integration.error_handling import RateLimiter
